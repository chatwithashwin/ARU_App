...
function ajaxCall(type,term,f1,f2,f3)
  ...
  { 
      ...
      {
        let tablerow =  '<tr><th scope="row"><div class="media align-items-center"><a href="#" class="avatar rounded-circle mr-3"><img alt="Image placeholder" src="https://raw.githack.com/creativetimofficial/argon-dashboard/master/assets/img/theme/bootstrap.jpg"></a><div class="media-body"><span class="mb-0 text-sm">#1</span></div></div></th><td>#2</td><td>#3</td><td>#4</td><td>$ #5</td><td><a onclick="getInvestmentDetails(this)"> <u>More details</u> </a></td>';
